...
$string = "AXSASXXMASAMXMXSASMMXMSAMXMXXMASMXMXMSMSMXMAXMSMSMSMXXMXMXMASXMASXMXSXSASXSXSSSSSSMSSMXMAASAMXXSSSMMXMMMSXSAXMASXMMXSXMAXSAMXAMXXMASMMXXSAXS
...
// Sample grid data
$grid = $test->FormatXMASInput($string);

// Call the method and print the result
$result = $test->countXMASOccurrences($grid);
echo "The word 'XMAS' appears $result times in the grid in part 1.\n";


$result = $test->countXMASOccurrencesInXShape($grid);
echo "The word 'XMAS' appears $result times in the grid in part 2.\n";
